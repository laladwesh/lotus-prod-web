  ...
  return (
    <div className="relative w-screen h-[80vh]">
      <div className="absolute inset-0 z-10 flex flex-col items-start justify-center p-8 text-white md:p-16">
        <h1 className="mb-2 text-3xl font-bold md:text-5xl">Lotus Traders</h1>
        <p className="mb-4 text-lg md:text-xl">
          Vision or Motto of Lotus in one line
        </p>
        <button
          onClick={() => console.log("haifaebi")}
          className="px-4 py-2 font-semibold text-black bg-gray-200 rounded hover:bg-gray-300"
        >
          Place Enquiry
        </button>
      </div>
      <Carousel plugins={[Autoplay({ delay: 2000 })]} className="w-full h-[80vh]">
        <CarouselContent>
          ...
          <CarouselItem className="relative w-full h-[80vh]">
            <Image src="/cat1.jpg" alt="Slide 2" fill className="object-cover" />
          </CarouselItem>
          <CarouselItem className="relative w-full h-[80vh]">
            <Image src="/cat1.jpg" alt="Slide 3" fill className="object-cover" />
          </CarouselItem>
        </CarouselContent>
      </Carousel>
    </div>
